...
import json, math, os, tempfile, uuid
...
app=FastAPI(title='WaterPulse AI Agent API', version='8.0')
...
@app.get('/api/health')
def health():
    return {'status':'ok','app':'WaterPulse AI Agent','version':'8.0','deepseek_configured':deepseek_configured(),'deepseek_model':deepseek_model(),'timestamp':now_iso()}
...
def agent_status():
    return {'status':'ok','agent_version':'8.0-chat-deepseek-inline-ui',
